...
module.exports = class HelpCommand extends commando.Command {
    constructor(client) {
        super(client, {
            ...
            group: 'meta',
            memberName: 'help',
            description: "Get a comprehensive list of Rio's commands.",
            details: oneLine`
            Get a comprehensive list of Rio's commands.
            `
        });
            ...
            msg.channel.send({
                embed: {
                    ...
                    },
                    {
                        ...
                        value : "For a complete command table, with info on usage, check out [my command page](https://silvia-odwyer.github.io/Rio-Discord-Bot-Website/commands.html)."
                    }
                    ],
                    footer: {
                        text: "Coded by User <3"
                    }
                }
            })
